...
class create_surrogate_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i55 in range(_size51):
                        ...
                        for _i61 in range(_size57):
                            ...
                            _elem56.append(_elem62)
                        iprot.readListEnd()
                        self.xt.append(_elem56)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i80 in range(_size76):
                        _elem81 = Distribution()
                        _elem81.read(iprot)
                        self.uncertainties.append(_elem81)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.options is not None:
            ...
            for kiter85, viter86 in self.options.items():
        ...
        if self.uncertainties is not None:
            ...
            for iter87 in self.uncertainties:
                iter87.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class qualify_args(object):
    ...
    def write(self, oprot):
        ...
        if self.xv is not None:
            ...
            for iter106 in self.xv:
                oprot.writeListBegin(TType.DOUBLE, len(iter106))
...
class predict_values_args(object):
    ...
    def write(self, oprot):
        ...
        if self.x is not None:
            ...
            for iter121 in self.x:
                oprot.writeListBegin(TType.DOUBLE, len(iter121))
