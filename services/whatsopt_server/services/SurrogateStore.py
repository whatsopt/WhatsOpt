...
class create_surrogate_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i101 in range(_size97):
                        _elem102 = Distribution()
                        _elem102.read(iprot)
                        self.uncertainties.append(_elem102)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.uncertainties is not None:
            ...
            for iter108 in self.uncertainties:
                iter108.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class qualify_args(object):
    ...
    def write(self, oprot):
        ...
        if self.xv is not None:
            ...
            for iter127 in self.xv:
                oprot.writeListBegin(TType.DOUBLE, len(iter127))
