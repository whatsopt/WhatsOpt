...
class SobolIndices(object):
    ...
    def __init__(self, first_order_indices=None, total_order_indexes=None,):
        self.first_order_indices = first_order_indices
        self.total_order_indexes = total_order_indexes
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        ...
                        self.first_order_indices.append(_elem12)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    self.total_order_indexes = []
                    (_etype16, _size13) = iprot.readListBegin()
                    for _i17 in range(_size13):
                        _elem18 = iprot.readDouble()
                        self.total_order_indexes.append(_elem18)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.first_order_indices is not None:
            oprot.writeFieldBegin('first_order_indices', TType.LIST, 1)
            oprot.writeListBegin(TType.DOUBLE, len(self.first_order_indices))
            for iter19 in self.first_order_indices:
                oprot.writeDouble(iter19)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.total_order_indexes is not None:
            oprot.writeFieldBegin('total_order_indexes', TType.LIST, 2)
            oprot.writeListBegin(TType.DOUBLE, len(self.total_order_indexes))
            for iter20 in self.total_order_indexes:
...
SobolIndices.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'first_order_indices', (TType.DOUBLE, None, False), None, ),  # 1
    (2, TType.LIST, 'total_order_indexes', (TType.DOUBLE, None, False), None, ),  # 2
)
