module WhatsOpt
  ...
  module Variable
    ...
    INPUT_ROLES = [DESIGN_VAR_ROLE]
    OUTPUT_ROLES = [MIN_OBJECTIVE_ROLE, MAX_OBJECTIVE_ROLE, EQ_CONSTRAINT_ROLE, INEQ_CONSTRAINT_ROLE, RESPONSE_ROLE]

    VARIABLE_ROLES = INPUT_ROLES + OUTPUT_ROLES + [STATE_VAR_ROLE]
