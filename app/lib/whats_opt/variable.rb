module WhatsOpt
  ...
  module Variable
    ...
    OUTPUT_ROLES = [MIN_OBJECTIVE_ROLE, MAX_OBJECTIVE_ROLE, EQ_CONSTRAINT_ROLE, INEQ_CONSTRAINT_ROLE]

    VARIABLE_ROLES = INPUT_ROLES + OUTPUT_ROLES + [RESPONSE_ROLE, STATE_VAR_ROLE]
