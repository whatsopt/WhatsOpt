  ...
  render() {
    ...
    return (
      <div className="editor-section">
        <label>Coefficients of determination R<sup>2</sup> for outputs computed from 10% of original DOE points used as validation set: <em>the closer to one, the better</em></label>
        <div>
