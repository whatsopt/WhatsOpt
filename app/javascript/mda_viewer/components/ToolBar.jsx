...
class ToolBar extends React.Component {
  ...
  render() {
    const lines = this.state.log.map((l, i) => (<OpenMDAOLogLine key={i} line={l} />));
    let btnStatusClass = this.state.statusOk ? 'btn btn-success' : 'btn btn-warning';
    let btnIcon = this.state.statusOk ? <i className="fa fa-check" /> : <i className="fa fa-exclamation-triangle" />;
