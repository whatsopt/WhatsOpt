...
class Analysis < ApplicationRecord
  ...
  scope :name_starts_with, ->(prefix) { where('lower(name) like ?', "#{prefix.downcase}%")}
  ...
  def neg_constraint_variables
    @ineqs = variables.with_role(WhatsOpt::Variable::NEG_CONSTRAINT_ROLE)
  end

  def pos_constraint_variables
  ...
  def response_dim
    Variable.vars_dim(response_variables)
  end
