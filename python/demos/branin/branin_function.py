# -*- coding: utf-8 -*-
"""
  branin_function.py generated by WhatsOpt. 
"""
import numpy as np
from branin_function_base import BraninFunctionBase

class BraninFunction(BraninFunctionBase):
    """ An OpenMDAO component to encapsulate BraninFunction discipline """
		
    def compute(self, inputs, outputs):
        """ BraninFunction computation """
        x_1 = inputs['x1']
        x_2 = inputs['x2']
        # f
...
# 
#    def setup()
#        super(BraninFunction, self).setup()
#        declare_partials('*', '*')  
#			
#    def compute_partials(self, inputs, partials):
#        """ Jacobian for BraninFunction """
#   
